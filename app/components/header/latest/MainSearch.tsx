...
const MainSearch = () => {
    ...
    return (
        <>
            ...
            <form action={appConfig.searchBaseUrl} className={`bg-gray-100 rounded-full h-[40px] flex place-items-center pl-[20px] gap-2 max-w-[50%] grow group hover:shadow hover:bg-white`}>
                <input type="text"
                    name="q"
                    defaultValue={query}
