...
const config = {
  BASE_URL: "https://index.bycet.com",
...
const getBusinessGallery = async (businessGuid) => {
  const BASE_URL = "https://index.bycet.com";
...
const SITE_BASE_URL = "https://index.bycet.com";
function useAuth() {
