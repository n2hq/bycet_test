import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{H as b}from"./HomeNav-Bl3ONTu6.js";import{L as f,r as t}from"./components-QUucBwvO.js";import{a6 as w,B as N,a as k,R as S,C as R,G as T,V as y,c as B,F as E,d as H,M as z}from"./lib-CWKz2Rp4.js";import{H as _,S as C,R as M,F as q}from"./Footer-Cmbhw4RX.js";import{U as F,M as G}from"./UserMenu-CRWTqlUo.js";import{T as L}from"./TopAd-D_i4FxZ2.js";import"./AccountUserImage-CD1O30HZ.js";import"./AuthContext-Cl3U3KD_.js";import"./css-CVxtJxAn.js";import"./index-Dc7kwL7j.js";import"./json-CkIhsVvA.js";const A=()=>e.jsx(f,{to:"/",children:e.jsx("div",{className:` text-[24px]
        ...
        tracking-tight`,children:"Categories"}),e.jsx("div",{className:`grid grid-cols-2 gap-5
          ...
          lg:grid-cols-4 lg:gap-10`,children:I.map((a,n)=>e.jsx("div",{children:e.jsx(f,{to:`${a.link}`,children:e.jsxs("div",{className:`border-[1px] h-[140px] md:h-[200px]
               ...
               gap-y-0 shadow-lg`,children:[e.jsx("div",{className:`text-[30px] w-12 h-12 rounded-full
                  ...
                  text-gray-500`,children:a.title})]})})},n))})]})}),se=()=>[{title:"Garssete | Business Directory, Travel, Real Estate, Hotels & Restaurants!"},{name:"Garssete",content:"Welcome to Garssete!"}],ae=()=>e.jsxs("div",{className:" h-screen ",children:[e.jsx("div",{className:"md:hidden",children:e.jsx(b,{})}),e.jsx("div",{className:"hidden md:block",children:e.jsx(D,{})}),e.jsx("div",{className:"",children:e.jsx(X,{})}),e.jsx(M,{category:"services",limit:8,title:"Recent Listings",subtitle:"Recent businesses or entities added by date."}),e.jsx("div",{className:"mt-[48px]"}),e.jsx(L,{}),e.jsx($,{}),e.jsx(q,{})]});export{ae as default,se as meta};
