import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{H as b}from"./HomeNav-BhFtCvZb.js";import{L as f,r as t}from"./components-QUucBwvO.js";import{a8 as w,B as N,a as k,R as S,C as R,G as T,X as y,c as B,F as E,d as H,M as z}from"./lib-gXVz7xpy.js";import{H as _,S as C,R as M,F as q}from"./Footer-_oKlS2Tk.js";import{U as F,M as G}from"./UserMenu-nzBRZyUB.js";import{T as L}from"./TopAd--T5UIMcP.js";import"./AccountUserImage-zrnI0bEK.js";import"./AuthContext-D6RspcLh.js";import"./LatestStarRating-7KoQDN7E.js";import"./css-CVxtJxAn.js";import"./index-D4GH3UrM.js";import"./json-8ypq0RNl.js";const X=()=>e.jsx(f,{to:"/",children:e.jsx("div",{className:` text-[24px]
        ...
        tracking-tight`,children:"Categories"}),e.jsx("div",{className:`grid grid-cols-2 gap-5
          ...
          lg:grid-cols-4 lg:gap-10`,children:I.map((a,n)=>e.jsx("div",{children:e.jsx(f,{to:`${a.link}`,children:e.jsxs("div",{className:`border-[1px] h-[140px] md:h-[200px]
               ...
               gap-y-0 shadow-lg`,children:[e.jsx("div",{className:`text-[30px] w-12 h-12 rounded-full
                  ...
                  text-gray-500`,children:a.title})]})})},n))})]})}),ae=()=>[{title:"Garssete | Business Directory, Travel, Real Estate, Hotels & Restaurants!"},{name:"Garssete",content:"Welcome to Garssete!"}],re=()=>e.jsxs("div",{className:" h-screen ",children:[e.jsx("div",{className:"md:hidden",children:e.jsx(b,{})}),e.jsx("div",{className:"hidden md:block",children:e.jsx(A,{})}),e.jsx("div",{className:"",children:e.jsx(D,{})}),e.jsx(M,{category:"services",limit:8,title:"Recent Listings",subtitle:"Recent businesses or entities added by date."}),e.jsx("div",{className:"mt-[48px]"}),e.jsx(L,{}),e.jsx($,{}),e.jsx(q,{})]});export{re as default,ae as meta};
