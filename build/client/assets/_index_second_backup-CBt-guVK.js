import{j as e}from"./jsx-runtime-0DLF9kdB.js";import{H as b}from"./HomeNav-BIeS0P5q.js";import{L as f,r as t}from"./components-DGrJwBOK.js";import{an as w,B as N,a as k,R as S,C as R,G as T,_ as y,c as B,F as E,d as H,M as _}from"./lib-k8WFHaWl.js";import{H as z,S as C,R as M,F as q}from"./Footer-D2y0aLLy.js";import{U as F,M as G}from"./UserMenu-DKsmTtXN.js";import{T as L}from"./TopAd-BcqHXSpK.js";import"./LeftNav-B93XguDD.js";import"./AuthContext-BZd2vK8z.js";import"./css-CVxtJxAn.js";import"./index-BcoEYQqA.js";const A=()=>e.jsx(f,{to:"/",children:e.jsx("div",{className:` text-[24px]
                cursor-pointer tracking-tight relative
                top-[-1px] font-poppins`,children:w()})}),D=()=>{const[a]=t.useState(1),[n,m]=t.useState(""),[r,l]=t.useState(!1),[i,o]=t.useState(!1),[x,j]=t.useState(!1),h=()=>o(!0),u=()=>o(!1);return t.useEffect(()=>{const p=()=>{window.scrollY>=a&&l(!0),window.scrollY<a&&l(!1)};window.onscroll=()=>p()},[a]),e.jsxs("div",{children:[e.jsx("div",{className:`z-[400] fixed w-full  h-[60px] 
      px-[15px] 
        ...
        tracking-tight`,children:"Categories"}),e.jsx("div",{className:`grid grid-cols-2 gap-5
          ...
          lg:grid-cols-4 lg:gap-10`,children:I.map((a,n)=>e.jsx("div",{children:e.jsx(f,{to:`${a.link}`,children:e.jsxs("div",{className:`border-[1px] h-[140px] md:h-[200px]
               ...
               gap-y-0 shadow-lg`,children:[e.jsx("div",{className:`text-[30px] w-12 h-12 rounded-full
                  ...
                  text-gray-500`,children:a.title})]})})},n))})]})}),te=()=>[{title:"Garssete | Business Directory, Travel, Real Estate, Hotels & Restaurants!"},{name:"Garssete",content:"Welcome to Garssete!"}],se=()=>e.jsxs("div",{className:" h-screen ",children:[e.jsx("div",{className:"md:hidden",children:e.jsx(b,{})}),e.jsx("div",{className:"hidden md:block",children:e.jsx(D,{})}),e.jsx("div",{className:"",children:e.jsx(X,{})}),e.jsx(M,{category:"services",limit:8,title:"Recent Listings",subtitle:"Recent businesses or entities added by date."}),e.jsx("div",{className:"mt-[48px]"}),e.jsx(L,{}),e.jsx($,{}),e.jsx(q,{})]});export{se as default,te as meta};
